<template>
  <div class="right-part">
    <right-buttons v-if="this.$store.getters['getCentrifugeConnection']"></right-buttons>
    <charger v-if="this.$store.getters['getCentrifugeConnection']"></charger>
    <converter></converter>
    <market-short-info
      v-if="this.$store.getters['getCentrifugeConnection']"
      class="market-short"/>
    <div class="right-part-footer">
      <img src="@/assets/resources/img/amhora-text.png" alt="" class="logo-right">
      <div class="social">
        <a href="https://t.me/amhora" target="_blank">
          <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="16" height="15" viewBox="0 0 16 15"><defs><path id="puupa" d="M1819.87 1027.872l-6.655 6.387a.4.4 0 0 0-.118.247l-.257 2.472c-.008.08-.112.091-.134.014l-1.054-3.687a.404.404 0 0 1 .153-.444l7.86-5.29c.18-.121.365.149.206.301zm1.81-2.816l-14.347 6.059c-.464.196-.436.919.042 1.072l3.646 1.167 1.36 4.678c.142.489.714.637 1.044.271l1.885-2.086 3.698 2.942c.453.36 1.098.093 1.212-.503l2.45-12.691c.12-.622-.445-1.14-.99-.91z"/></defs><g><g transform="translate(-1807 -1025)"><use fill="#41464a" xlink:href="#puupa"/></g></g></svg>
        </a>
        <a href="https://twitter.com/amhora_com" target="_blank" class="twitter-link">
...
import MarketShortInfo from './MarketShortInfo'
export default {
  name: 'RightNavigation',
  components: { Converter, RightButtons, Charger, MarketShortInfo },
  computed: {
    fiat () {
  ...
  methods: {
    setNewRate (resp) {
      this.$store.commit('CHANGE_RATE', resp)
    },
    socketHandler ({ event, data }) {
        this.setNewRate(data)
      }
  }
}
</script>
...
<style scoped lang="scss">
  ...
  .right-part > div:not(.right-part-footer){
    margin-bottom: 50px;
    flex-shrink: 0;
  }
