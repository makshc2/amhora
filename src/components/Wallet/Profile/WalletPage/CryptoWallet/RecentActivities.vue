<template>
    <div class="full-width q-mt-lg avenir-font-family scroll-y" style="max-height: 650px">
        <div class="q-mb-lg row justify-between">
            ...
            <div class="wrapper_select row">
                <div class="address-tx-history-header__filter row q-mr-md">
                    <span class="address-tx-history-header__filter-text q-mr-md text-grey-5">{{$t('address_info.sort_by')}}</span>
                    <SmallSelect
                ...
                <div class="address-tx-history-header__filter row">
                    <span class="address-tx-history-header__filter-text q-mr-md text-grey-5">{{$t('address_info.show')}}</span>
                    <SmallSelect
                            :items="showVariables"
                            :value="show"
